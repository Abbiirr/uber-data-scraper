...
file_path = "location-files/Remaining_Locations__No_Coordinates_Found_-6.csv"
...
# OpenCage API Key
API_KEY = "c7ea9b3164044ec38f890234bd18b5be"

# Output CSV file
output_file_path = "location_with-coordinates-6.csv"
